...
$form["title"]			= 'Zabbix Reseler';
$form["description"]	= "";
$form["name"]			= "zabbix_admin";
$form["action"]			= "parameter_reseller_edit.php";
$form["db_table"]		= "zabbix_client";
$form["db_table_idx"]	= "client_id";
$form["db_history"]		= "yes";
$form["tab_default"]	= "parameters"; // Onglet par defaut
$form["list_default"]	= "parameter_reseller_list.php";
$form["auth"]  = 'no'; // yes / no

// TODO : Add email parameters

$form["tabs"]['parameters'] = [
	'title'  => 'Zabbix Reseler Parameters',
	'width'  => 100,
	'template'  => "templates/parameter_reseller_edit.htm",
	'readonly' => false,
	'fields'  => [
		//#################################
